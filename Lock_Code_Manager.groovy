/**
 *  Change or Delete Lock Codess
 *
 *  Author: Ashutosh Jaiswal
 */
 
definition(
    name: "SmartDots: Lock Code Manager",
    namespace: "SmartDots",
    author: "Ashutosh J",
    description: "This app alows you to change or delete the user codes for your smart door locks",
    category: "Safety & Security",
    iconUrl: "https://cdn4.iconfinder.com/data/icons/gray-toolbar-7/512/registration-512.png",
    iconX2Url: "https://cdn4.iconfinder.com/data/icons/gray-toolbar-7/512/registration-512.png")
...
def codereturn(evt) {
    ...
    if (code == "") {
        ...
        def message = "Code for $username in slot $evt.value was set to $code on $evt.displayName"
        send(message)
    }
}
